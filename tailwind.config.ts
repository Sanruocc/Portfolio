  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-gold-metallic': 'var(--gradient-gold-metallic)',
      },
      keyframes: {
        'accordion-down': {
          from: {
        ...
        'luxury-glow': {
          '0%, 100%': { boxShadow: '0 0 20px hsl(262 83% 58% / 0.2), 0 0 40px hsl(262 83% 58% / 0.1)' },
          '50%': { boxShadow: '0 0 30px hsl(262 83% 58% / 0.4), 0 0 60px hsl(262 83% 58% / 0.2)' },
        },
        'luxury-shimmer': {
